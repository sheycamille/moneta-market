...
use App\Libraries\MobiusTrader\MtCache;
use App\Libraries\MobiusTrader\MtSearch;
...
class MobiusTrader
{
    ...
    public function password_set($client_id, $login, $password)
    {
        $result = $this->_client->call('PasswordSet', array(
            ...
            'Login' => $login,
            'Password' => $password,
            'SessionType' => self::SESSION_TYPE_TRADER,
        ));
    ...
    {
        return new MtSearch($this->_client, func_get_args());
    }

    public function search_array(array $columns)
    {
        return new MtSearch($this->_client, $columns);
    }

    public static function expr($string)
    {
        return MtSearch::expr($string);
    }
