    ...
    <td class="row" style="padding:35px 30px 11px 30px;font-size:0;background-color:#ffffff; text-align:center;">
        ...
        <div class="col-sml"
            ...
            <a style="text-align:center;" href="https://apps.apple.com/gb/app/mobiustrader-7/id1355359598"
                target="_blank">
                <img  src="{{ URL::to('/') }}/dash/images/app-store-en.png" alt="iPhone Download" tilte="iPhone Download"
                    height="66" />
                <br><br>
                <span>Download Now</span>
            </a>
        ...
        <div class="col-sml"
            ...
            <a style="text-align:center;"
                ...
                <img class="col-md-6" src="{{ asset('dash/images/windows.png') }}" alt="Trader7" tilte="Trader7"
                    height="80" />
                <br> <br>
                <span>Download Now</span>
            </a>
    ...
    <td class="row"
        ...
        <div class="col-sml"
            ...
            <a style="text-align:center;"
                ...
                <img class="" src="{{ asset('dash/images/google_play_badge.png') }}" alt="Windows Download"
        ...
        <div class="col-sml"
            ...
            <a style="text-align:center;"
                ...
                target="_blank">
                <img src="{{ asset('dash/images/app-store-en.png') }}" alt="MacOS Download" tilte="MacOS Download"
                    height="66" />
                <br><br>
                <span>Download Now</span>
            </a>
        ...
        <div class="col-sml"
            ...
            <a style="text-align:center;"
                ...
                <img class="col-md-6" src="{{ asset('dash/images/windows.png') }}" alt="Linux Download"
