...
return [
    ...
    'home' => [
        ...
        'why_us' => 'Why Moneta Market is a trusted FX broker?',
    ...
    'webtrader' => [
        ...
        'webtrader_platform' => '  Our WebTrader platform is fast becoming one of the most popular used by traders, providing an added level of market analysis and access to full market depth on an impressive and fully customisable user interface. Alongside Moneta Market’s advanced trading infrastructure, competitive pricing and superior order execution with no dealing desk intervention*, our WebTrader provides one of the most innovative trading experiences in the industry.',
    ...
    'about' => [
        ...
        'aim' => 'At Moneta Market we evolve with the times. We aim to continuously refine our services to cater to the needs of traders in this highly dynamic industry',
        ...
        'phil_text' => 'At Moneta Market, we strive to bring innovative products to our clients. We  continuously refine our services to cater to the needs of traders in this highly dynamic industry.',
    ...
    'security' => [
        ...
        'safety' => 'At Moneta Market, the safety of client data is a priority and we have sophisticated security measures in place designed to protect your personal information, privacy and funds',
        ...
        'disclose_pt2' => 'Moneta Market and other reputable companies would never ask for such details and you should deem any such contact or requests to be suspicious',
        ...
        'for_clarity' => 'For clarity, we would like to highlight that Moneta Market',
        ...
        'fraud_pt2' => 'If you receive any unsolicited calls, emails or SMS claiming to be Moneta Market, do not engage in any communication and report this to us immediately via our official communication channels on our website',
    ...
    'trading_platforms' => [
        ...
        'more_features' => 'Enjoy more features with Moneta Market’ Trader7 trading platform. The Moneta Market Trader7 is the latest and most advanced Trader7 platform that offers all the pioneering features of MT4, with the addition of more advanced trading tools and indicators that enable traders to maintain more control of their trades and make more informed decisions using cutting-edge analysis',
    ...
    'privacy_policy' => [
        ...
        'b1' => 'Moneta Market is always looking to improve the experience of our clients in more ways than one and in
        an effort to create and manage every trading account our clients have, the company will need to
        access some necessary information from them. The Policy on Privacy Protection indicates how Moneta Market
        ...
        'security' => 'Security',
        'cookies' => 'Cookies on MonetaMarket.com',
        ...
        'links' => 'Links',
        'b13' => 'Our website, Moneta Market.com, may contain links to other websites on the internet. We are not, in
    ...
    'order_execution' => [
        ...
        'b1' => 'The sole purpose of this Order of Execution policy is to establish a well-organized action plan for the procurement process by providing the finest conceivable result for its Clients, while Moneta Market accomplishing a Clients’ orders.',
        ...
        'b3' => 'The policy shall apply automatically upon the completion of trades on behalf of its Clients. Moneta Market will continually be the principal counterparty as the orders of Clients are accomplished.',
        'b4' => 'More so, Moneta Market cannot assure that once an order is given, the Client’s expense will be beneficial than original value which could perhaps be obtainable in a different occurrence. ',
        'exe' => 'Execution Aspects',
        'b5' => 'Moneta Market is required to take several aspects into deliberation; the following are itemized below:',
        'b6' => 'More so, Moneta Market cannot assure that once an order is given, the Client’s expense will be beneficial than original value which could perhaps be obtainable in a different occurrence.',
        'quotes' => ' Quotes',
        'b7' => 'Moneta Market creates an owned tradable values taken from the figures obtained over the liberated price sources, counting banks that principally offers liquescency through the global market. Moneta Market is to guarantee that the bid/ask spread controls is completed with the recommendation to an extensive assortment of fundamental price sources, counting statistical bases. With such, Moneta Market can assure that the Client receives the best execution possible. ',
        'charges' => ' Charges',
        ...
        'b9' => 'Orders are positioned in portion scopes. A component which processes the quantity of the deal is termed as “lot”, in which varies from every financial instruments given. If a Client desired to instigate an outsized scope of order, it may not be as much as favorable in several circumstances as liquidity ascends in the marketplace. Moneta Market holds the right to refuse a Clients’ Order, if the size of the order is considered to be too large and cannot be completed by Moneta Market. ',
        'frequency' => 'Frequency',
        'b10' => 'Normally, Price values often changes in every coming periods. The regularity with which they do varies with financial instruments along with the current market conditions. As Moneta Market produces its own tradable price values, the technology therefore used by the Client to make relations with Moneta Market will play a decisive function. Additionally, tradable prices are distributed through the Moneta Market’s trading programs.',
        'instruments' => 'Instruments',
        'b11' => 'Moneta Market fulfills orders in relation to any trading instruments in derivatives on foreign exchange ("FX").',
        'b12' => 'Moneta Market provides the following foreign exchange trading products:',
        ...
        'l6' => 'When an order of a Client is being accomplished, Moneta Market is authorized to layout the following factors into observation:',
        ...
        'b13' => 'In circumstances where the Client is given with a definite directive by Moneta Market concerning the order execution and the company decided on this directive, consequently, an execution of order will be executed with the specific instruction given.',
        'b14' => 'Still, if the Client wanted to perform an order and given a certain instruction, then by executing that order, Moneta Market will fulfill with Moneta Market’s responsibility to deliver the best execution for the Client. This may possible result in being unqualified to comply with Moneta Market’s order execution policy for that certain order.',
        ...
        'b16' => 'In general, the funds placed in the accounts by Clients with Moneta Market, counting orders that are positioned towards a trading platform is secured by Moneta Market and is the one accountable for the capitals entirely. ',
        'review' => 'Review and Monitoring',
        'b21' => 'Moneta Market’s implemented policy will definitely be monitored, including the substantial order execution provisions, predominantly on an constant foundation to regulate and suggest better improvements.',
        'b17' => 'It is also mandatory for the company to evaluate the Policy and the pertinent order execution preparations on a systematic basis in any case so as to measure if Moneta Market is competent enough to deliver the best execution for its Clients. ',
        'permissions' => 'Clients Permissions',
        'b18' => 'Moneta Market is required to get the Client’s prior approval to this Policy when making a business association regarding the Client. Furthermore, Moneta Market is mandated to take in the Client’s prior approval before the implementation of Clients’ orders or getting or conducting orders for execution.',
        'b19' => 'Moneta Market is capable to acquire the abovementioned agreements under a broad settlement.',
    ...
    'terms_service' => [
        ...
        herein. This document, which is a legal contract between the client and Moneta Market (“Moneta Market ,” “Company,” “we,” “us,” “our”), shall determine the responsibilities and rights of Moneta Market and its clients in connection with the Company’s services.',
        ...
        capable of managing transactions on a regular basis. Moneta Market has provided a Declaration
        ...
        'b5' => 'Moneta Market powered by Moneta Market Ltd. (Registration No. 936729). A Company with
    ...
    'headings' => [
        'head' => 'HEADINGS',
        'b1' => '“Moneta Market” refers to the Company, affiliates, subordinates, and their beneficiaries;',
    ...
    'application' => [
        ...
        obligations and rights set at the time that the Client started to trade using Moneta Market
    ...
    'eligibility' => [
        ...
        services Moneta Market provides are intended only for clients who are not prohibited by
    ...
    'offerings' => [
        ...
        'b1' => "Moneta Market offers a variety of trading Services to clients and these include
    ...
    'funding' => [
        ...
        to the withdrawal. It is the exclusive right of Moneta Market to reject any other withdrawal
    ...
    'client_fund' => [
        'head' => 'CLIENT FUND ',
        'b1' => "Moneta Market shall be allowed to keep the client's funds for the use of trading. Losses
    ...
    'fund_transfer' => [
        ...
        account, the Client affirms that such action is performed under his/her own risk, as Moneta Market cannot be held liable for your action and is not obliged to make any
        ...
        should submit a formal request subject to approval. Moneta Market may dismiss funds
        transfer requests. ',
    ...
    'responsibility' => [
        ...
        'b7' => 'All conversations between the Client and Moneta Market workforces may be electronically
        ...
        recordings are sole properties of the Company; Moneta Market therefore reserves the
    ...
    'bonus' => [
        ...
        the required trading volume determined by Moneta Market is met (minimum trading
        ...
        the trading account of the Client. Moneta Market also reserves the right to block the
        Client's trading account and return the balance to the Client.",

    ],
    'seclusion' => [
        'head' => 'SECLUSION OF CLIENT FUNDS AND CURRENCY CONVERSIONS   ',
        'b1' => "Moneta Market shall conduct money it holds on the Client's behalf as clients' funds. The
        ...
        'b2' => "Moneta Market coordinates with various credit institutions; a complete list of these
    ...
    'fees' => [
        ...
        'b1' => "Clients may be required to pay the cost and charges outlined in Moneta Market's Service
        ...
        that instituted the professional connection between the Moneta Market workforces and
        the clients.  ",
    ...
    'margin' => [
        ...
        changed at any time. Moneta Market may impose maximum requirements to comply with
        ...
        account and margin level, while Moneta Market may elect to limit the trades and
    ...
    'abritage' => [
        ...
        'b1' => "Moneta Market strictly prohibits any form of arbitrage and manipulation of its platform,
    ...
    'derivatives_policy' => [
        ...
        matter. Moneta Market can execute orders of the client, but is not obliged to do so,
    ...
    'investment_advice' => [
        ...
        'b1' => "Based on what the Company considers reliable, Moneta Market and all its workforces
    ...
    'disputes' => [
        ...
        have had with respect to Moneta Market regarding such discrepancy since the impossibility
        ...
        agrees to pay Moneta Market reputational damages of $100.00 per day from the time of
        such violation, while the cumulative maximum of the payment may reach $10,000.00.',
        'b6' => 'The Client and Moneta Market undertake to make every effort to resolve any dispute, in good
        faith and on a constructive basis. The Client acknowledges and agrees that threats and/or
        blackmail against Moneta Market is/are prohibited and is/are the legitimate ground/s for the
        termination of negotiations and the immediate termination of any business relationship.',
        'b7' => 'Without prejudice to any other Moneta Market rights under these Terms, if the parties are in
        dispute regarding a trade warrant, Moneta Market has the right in its sole discretion and
        without prior notice to accept any opinion and actions that it considers reasonable to limit
        the maximum amount involved in the dispute. Moneta Market is not liable to the Customer,
    ...
    'indemnification' => [
        ...
        'b1' => "You acknowledge that Moneta Market and its workforces shall not be held liable for any
        losses, costs, expenses and damages that may arise in case the Client fails to
        accomplish his/her obligations in this Agreement. Moneta Market is free of liability in all
        claims that may have been contributed by system and/or equipment error of Moneta Market
    ...
    'confidential' => [
        ...
        property rights are exclusive property of Moneta Market and its licensors. All of these and
    ...
    'termination' => [
        ...
        positions; and that no amount is owed by the Client to Moneta Market. The Client may
        ...
        towards the Company, Moneta Market reserves the right to call back all profits
        generated from the Company's services. Moneta Market has the sole and exclusive
    ...
    'reviews' => 'Reviews',
    'daily_market_reviews' => 'Daily market reviews from the Moneta Market Analyst Team',
    'knowledge' => 'Knowledge',
    ...
    'why_trade' => 'Why Trade with Moneta Market',
    ...
    'growth' => 'Moneta Market has grown exponentially over the years and has become renowned for providing elite trading conditions to its clients',
    ...
    'your_data' => 'How Moneta Market Protects Your Data',
    ...
    'copyright' => 'Copyright © 2022 Moneta Market. All rights reserved.',
